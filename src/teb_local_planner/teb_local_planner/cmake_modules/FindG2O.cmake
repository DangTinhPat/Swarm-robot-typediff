...
IF(UNIX)
  ...
  # Modern g2o (incl. the ros-jazzy-libg2o binary package) installs headers
  # under <prefix>/include/g2o/... and is included as <g2o/config.h>, so
  # G2O_INCLUDE_DIR must resolve to <prefix>/include (the parent), not
  # <prefix>/include/g2o - the original NAMES/PATH_SUFFIXES combo here
  # matched the g2o/ subdir itself, which broke every #include <g2o/...>
  # in this codebase with "No such file or directory".
